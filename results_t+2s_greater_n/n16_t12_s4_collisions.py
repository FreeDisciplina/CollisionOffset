...
ax1.set_title('Number of collisions on each offset ($n=16, t=12, s=4$)', fontsize=10, fontweight='bold')
ax1.set_xlabel('offset ($[0, 2^4]$)')
ax1.set_ylabel('$\log_2(\#\mathrm{collisions})$')
